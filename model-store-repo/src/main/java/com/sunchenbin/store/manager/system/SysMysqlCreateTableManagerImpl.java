...
public class SysMysqlCreateTableManagerImpl implements SysMysqlCreateTableManager {
	 ...
	 * 指定数据库
	 */
	@Value("#{configProperties['db.name']}")
	...
	private void allTableMapConstruct(Map<String, Object> mySqlTypeAndLengthMap, Set<Class<?>> classes,
			...
			Map<String, List<Object>> dropKeyTableMap, String dbName) {
		...
		for (Class<?> clas : classes) {
			...
			// 先查该表是否以存在
			int exist = createMysqlTablesMapper.findTableCountByTableName(table.name(), dbName);
			...
			if (exist == 0) {
				...
				List<SysMysqlColumns> tableColumnList = createMysqlTablesMapper
						.findTableEnsembleByTableName(table.name(), dbName);
				...
				buildAddAndRemoveAndModifyFields(mySqlTypeAndLengthMap, modifyTableMap, addTableMap, removeTableMap,
						dropKeyTableMap, table, newFieldList, removeFieldList, addFieldList, modifyFieldList,
						dropKeyFieldList, tableColumnList, columnNames);
	...
	private void buildAddAndRemoveAndModifyFields(Map<String, Object> mySqlTypeAndLengthMap,
			...
			Map<String, List<Object>> removeTableMap, Map<String, List<Object>> dropKeyTableMap, Table table,
			List<Object> newFieldList, List<Object> removeFieldList, List<Object> addFieldList,
			List<Object> modifyFieldList, List<Object> dropKeyFieldList, List<SysMysqlColumns> tableColumnList,
		...
		// 3. 找出更新的字段
		buildModifyFields(mySqlTypeAndLengthMap, modifyTableMap, dropKeyTableMap, table, modifyFieldList,
				dropKeyFieldList, tableColumnList, fieldMap);
	}
	...
	private void buildModifyFields(Map<String, Object> mySqlTypeAndLengthMap, Map<String, List<Object>> modifyTableMap,
			Map<String, List<Object>> dropKeyTableMap, Table table, List<Object> modifyFieldList,
			List<Object> dropKeyFieldList, List<SysMysqlColumns> tableColumnList,
